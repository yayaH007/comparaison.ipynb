...
location = 'C:/Users/eyaha/PycharmProjects/Memoire/CoursActionsAirbnb.sqlite'
...
class ScrapeTableSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.boursorama.com/cours/actualites/ABNB/page-'+str(i+1) for i in range(3)]
    ch=''
    def parse(self, response):
        fichier = open("links_airbnb.txt", "w")
...
'//*[@id="main-content"]/div/section[1]/div[2]/article/div[2]/div[2]/div[1]/div[2]/ul/li[5]/p'
'//*[@id="main-content"]/div/section[1]/div[2]/article/div[2]/div[2]/div[1]/div[2]/ul/li[5]/div[3]'
