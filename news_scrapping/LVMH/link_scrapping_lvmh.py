...
location = 'C:/Users/eyaha/PycharmProjects/Memoire/CoursActionsLVMH.sqlite'
...
class ScrapeTableSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.boursorama.com/cours/actualites/1rPMC/page-'+str(i+1) for i in range(101)]
    ch=''
    def parse(self, response):
        fichier = open("links_lvmh.txt", "w")
